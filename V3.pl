...
3.	O regime de contratação é compatível com o regime de contratação pretendido pelos candidatos?
4.	A faixa de salário oferecida é compatível com as pretendidas?
5.	Quais candidatos estão aptos a participar do processo seletivo?
6.	Quais candidatos estão na cidade da empresa recrutadora?
...
company(empresaA, cidadeA, remoto, 4000, junior, python, pj).
...
/*
 * 3.	O regime de contratação é compatível com o regime de
 * contratação pretendido pelos candidatos?
 * 
 * clt/pj
 */
